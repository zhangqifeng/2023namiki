...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'employee', name: 'employee', meta: { name: '员工信息' }, component: () => import('../views/manager/Employee') },
      ...
      { path: 'resources', name: 'Resources', meta: { name: '资产信息' }, component: () => import('../views/manager/Resources.vue') },
